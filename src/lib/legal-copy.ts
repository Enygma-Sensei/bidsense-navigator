...
export const POLICIES: PolicyDoc[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Secrets", body: "No secrets in the client bundle. OPENAI_API_KEY and Stripe keys held in server-side secret storage; rotated on personnel change." },
      { heading: "Logging & monitoring", body: "Structured application logs, error reporting, and request IDs propagated for traceability. Alerting on error rates, latency, and auth anomalies." },
      ...
      { heading: "Sub-processor register", body: "Stripe (payments), Supabase (auth, storage, database), OpenAI (model inference), Cloudflare (edge runtime)." },
    ],
  },
];
